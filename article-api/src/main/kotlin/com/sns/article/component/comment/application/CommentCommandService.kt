...
import com.sns.article.endpoints.comment.CommentCommand
...
class CommentCommandService(
    ...
    override fun create(type: Comment.Root.Type, rootId: String, contents: String, writerId: String) {
    ...
    override fun updateContents(id: Long, contents: String, writerId: String) {
